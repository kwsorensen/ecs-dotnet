...
namespace Elastic.CommonSchema
{
	...
	{
		/// <summary>
		/// Unique identifier of the transaction.<para/><para/>A transaction is the highest level of work measured within a service, such as a request to a server.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
	...
	public class Agent 
	{
		...
		/// <summary>
		/// Type of the agent.<para/><para/>The agent type stays always the same and should be given by the agent used. In case of Filebeat the agent would always be Filebeat also if two Filebeat instances are run on the same machine.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
	...
	public class Client 
	{
		...
		/// <summary>
		/// IP address of the client.<para/><para/>Can be one or multiple IPv4 or IPv6 addresses.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		[DataMember(Name = "ip")]
		public string Ip { get; set; }
		...
		/// <summary>
		/// The highest registered client domain, stripped of the subdomain.<para/><para/>For example, the registered domain for "foo.google.com" is "google.com".<para/><para/>This value can be determined precisely with a list like the public suffix list (http://publicsuffix.org). Trying to approximate this by simply taking the last two labels will not work well for TLDs such as "co.uk".
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		...
		/// <summary>
		/// The effective top level domain (eTLD), also known as the domain suffix, is the last part of the domain name. For example, the top level domain for google.com is "com".<para/><para/>This value can be determined precisely with a list like the public suffix list (http://publicsuffix.org). Trying to approximate this by simply taking the last label will not work well for effective TLDs such as "co.uk".
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
	...
	public class Destination 
	{
		...
		/// <summary>
		/// IP address of the destination.<para/><para/>Can be one or multiple IPv4 or IPv6 addresses.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		[DataMember(Name = "ip")]
		public string Ip { get; set; }
	...
	public class Event 
	{
		...
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>https://system.vendor.com/event/#0001234</example>
		[DataMember(Name = "reference")]
		public string Reference { get; set; }

		/// <summary>
		/// URL linking to an external system to continue investigation of this event.<para/><para/>This URL links to another system where in-depth investigation of the specific occurence of this event can take place. Alert events, indicated by `event.kind:alert`, are a common use case for this field.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>https://mysystem.mydomain.com/alert/5271dedb-f5b0-4218-87f0-4ac4870a38fe</example>
		[DataMember(Name = "url")]
	...
	public class HttpRequest
	{
		...
		/// <summary>
		/// HTTP request method.<para/><para/>The field value must be normalized to lowercase for querying. See the documentation section "Implementing ECS".
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
	...
	/// <summary>
	/// InnerVlan, property of <see cref="NetworkInner" />
	/// </summary>
	public class InnerVlan
	{
		/// <summary>
		/// Inner VLAN ID as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>10</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Inner Optional VLAN name as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>outside</example>
		[DataMember(Name = "")]
	...
	/// <summary>
	/// EgressInterface, property of <see cref="ObserverEgress" />
	/// </summary>
	public class EgressInterface
	{
		/// <summary>
		/// Egress Interface ID as reported by an observer (typically SNMP interface ID).
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>10</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Egress Interface name as reported by the system.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>eth0</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Egress Interface alias as reported by the system, typically used in firewall implementations for e.g. inside, outside, or dmz logical interface naming.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>outside</example>
		[DataMember(Name = "")]
	...
	/// <summary>
	/// EgressVlan, property of <see cref="ObserverEgress" />
	/// </summary>
	public class EgressVlan
	{
		/// <summary>
		/// Egress VLAN ID as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>10</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Egress Optional VLAN name as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>outside</example>
		[DataMember(Name = "")]
	...
	public class ObserverEgress
	{
		...
		/// </summary>		   
		[DataMember(Name = "interface")]
		public EgressInterface Interface { get; set; }

		/// <summary>
		/// Vlan property.
		/// </summary>		   
		[DataMember(Name = "vlan")]
		public EgressVlan Vlan { get; set; }
	...
	/// <summary>
	/// IngressInterface, property of <see cref="ObserverIngress" />
	/// </summary>
	public class IngressInterface
	{
		/// <summary>
		/// Ingress Interface ID as reported by an observer (typically SNMP interface ID).
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>10</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Ingress Interface name as reported by the system.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>eth0</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Ingress Interface alias as reported by the system, typically used in firewall implementations for e.g. inside, outside, or dmz logical interface naming.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>outside</example>
		[DataMember(Name = "")]
	...
	/// <summary>
	/// IngressVlan, property of <see cref="ObserverIngress" />
	/// </summary>
	public class IngressVlan
	{
		/// <summary>
		/// Ingress VLAN ID as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>10</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Ingress Optional VLAN name as reported by the observer.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>outside</example>
		[DataMember(Name = "")]
	...
	public class ObserverIngress
	{
		...
		/// </summary>		   
		[DataMember(Name = "interface")]
		public IngressInterface Interface { get; set; }

		/// <summary>
		/// Vlan property.
		/// </summary>		   
		[DataMember(Name = "vlan")]
		public IngressVlan Vlan { get; set; }
	...
	/// <summary>
	/// ParentCodeSignature, property of <see cref="ProcessParent" />
	/// </summary>
	public class ParentCodeSignature
	{
		/// <summary>
		/// Parent Boolean to capture if a signature is present.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		/// <example>true</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Subject name of the code signer
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		/// <example>Microsoft Corporation</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Boolean to capture if the digital signature is verified against the binary content.<para/><para/>Leave unpopulated if a certificate was unchecked.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>true</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Stores the trust status of the certificate chain.<para/><para/>Validating the trust of the certificate chain may be complicated, and this field should only be populated by tools that actively check the status.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>true</example>
		[DataMember(Name = "")]
		...
		/// <summary>
		/// Parent Additional information about the certificate status.<para/><para/>This is useful for logging cryptographic errors with the certificate validity or trust status. Leave unpopulated if the validity or trust of the certificate was unchecked.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
		/// <example>ERROR_UNTRUSTED_ROOT</example>
		[DataMember(Name = "")]
	...
	/// <summary>
	/// ParentHash, property of <see cref="ProcessParent" />
	/// </summary>
	...
	{
		/// <summary>
		/// CodeSignature property.
		/// </summary>		   
		[DataMember(Name = "codesignature")]
		public ParentCodeSignature CodeSignature { get; set; }

		/// <summary>
		/// Hash property.
		/// </summary>		   
		[DataMember(Name = "hash")]
		public ParentHash Hash { get; set; }
		...
		/// <summary>
		/// Array of process arguments.<para/><para/>May be filtered to protect sensitive information.
		/// </summary>
		/// <remarks>(ECS Extended)</remarks>
	...
	public class Server 
	{
		...
		/// <summary>
		/// IP address of the server.<para/><para/>Can be one or multiple IPv4 or IPv6 addresses.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		[DataMember(Name = "ip")]
		public string Ip { get; set; }
	...
	public class Source 
	{
		...
		/// <summary>
		/// IP address of the source.<para/><para/>Can be one or multiple IPv4 or IPv6 addresses.
		/// </summary>
		/// <remarks>(ECS Core)</remarks>
		[DataMember(Name = "ip")]
		public string Ip { get; set; }
...
{
	/// <summary>
	/// Elastic Common Schema version 1.5.0 index templates to be used with Elasticsearch.
	/// </summary>
	public static class IndexTemplates
	{
		/// <summary>
		/// Elastic Common Schema version 1.5.0 index template for Elasticsearch version 6
